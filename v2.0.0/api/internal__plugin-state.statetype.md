...
Describes the states of a \[\[Plugin\]\]. Please note that a state type will be
...
the built-in \[\[boolean\]\], \[\[number\]\], \[\[string\]\], \[\[scalar\]\] and
\[\[serializedScalar\]\], \[\[list\]\], \[\[object\]\], and \[\[child\]\] state
types
